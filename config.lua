Config = {
        ...
        AcePerm = "exory.owner", -- The ACE Permissions that has access to the staff chat and is considered an online staff member, only works if your not using the Discord Rest API Option.
